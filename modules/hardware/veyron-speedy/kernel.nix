{ lib, pkgs, ... }: pkgs.linuxPackagesFor (pkgs.linux_latest.override {
  autoModules = false;
  structuredExtraConfig = with lib.kernel; {
    ...
    SND_SEQ_MIDI = module;
    SND_PCM_IEC958 = module;
    SND_SOC_ROCKCHIP = module;
    SND_SOC_ROCKCHIP_I2S = module;
    SND_SOC_ROCKCHIP_MAX98090 = module;
    SND_SOC_RK3288_HDMI_ANALOG = module;
    SND_SOC_MAX98090 = module;
